...
- ✓ *Проверка добавленной книги в профиль пользователя*
- ✓ *Проверка удаления книги из профиля пользователя*
- ✓ *Проверка создания пользователя с НЕ корректными данными для авторизации*
- ✓ *Проверка создания пользователя с корректными данными для авторизации*
...
- *browser (браузер на выбор = chrome или firefox, по умолчанию chrome)*
- *version (версия браузера для chrome = 127 или 128, для firefox = 124 или 125 , по умолчанию 127)*
...
___
<a id="allure"></a>
## <img alt="Allure" height="25" src="images/logo/Allure.svg" width="25"/></a> <a name="Allure"></a>Allure [отчет](https://jenkins.autotests.cloud/job/nryazanov_my_project_16/allure/)</a>
___
